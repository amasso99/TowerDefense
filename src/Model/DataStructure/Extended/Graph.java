...
public class Graph<T, R extends Comparable<R>> {
    ...
    public List<Vertex<T>> getVertices() {
        return Utils.cloneList(vertices);
    }
     ...
     */
    public Vertex<T> getVertex(T pID) {
        return Utils.find(vertices, x -> x.getContent().equals(pID));
    }
     ...
     */
    public void addVertex(Vertex<T> pVertex) {
        Utils.addIfNotExists(vertices, pVertex);
    }
     ...
     */
    public void removeEdge(Edge<T, R> pEdge) {
    ...
    public void setAllEdgeMarks(boolean pMark) {
        edges.toFirst();
        while (edges.hasAccess()) {
            edges.getContent().setMarked(pMark);
            edges.next();
        }
    }
     ...
     * wird eine leere Liste zurueckgeliefert.
     */
    public List<Edge<T, R>> getEdges(Vertex<T> pVertex) {
        List<Edge<T, R>> result = new List<>();
