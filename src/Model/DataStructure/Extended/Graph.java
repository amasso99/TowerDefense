 ...
 * </p>
 * <p>
 * Die Klasse Extended stellt einen ungerichteten, kantengewichteten Graphen dar. Es koennen
 ...
 * Knotenobjekt zu einer bestimmten ID gehoert und ob der Extended leer ist.
 * </p>
 * 
...
public class Graph{
  ...
  /**
   * Ein Objekt vom Typ Extended wird erstellt. Der von diesem Objekt
   * repraesentierte Extended ist leer.
   */
  public Graph(){
  ...
  /**
   * Die Anfrage liefert true, wenn der Extended keine Knoten enthaelt, ansonsten false.
   */
